...
// use sp_core::ed25519::Pair as Pair2;
...
fn main() {
    ...
    let phrase = "bar congress fly town evolve decide gloom various funny twist modify inmate";
    // let (pair, seed) = Mnemonic::from_phrase(phrase, Language::English)
    //     .map_err(|_| SecretStringError::InvalidPhrase)
    //     .map(|m| Pair2::from_entropy(m.entropy(), None))
